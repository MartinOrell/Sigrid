...
void GraphicBoard::addTileColumnRight(const std::vector<int>& repeatTileColorIds){
    ...
    if(m_labelsPtr){
        ...
        m_labelsPtr->moveRightOutsideCoordinateLabels(sf::Vector2f{m_tileLayerPtr->getTileSize().x,0.f});
...
void GraphicBoard::addTileRowUp(const std::vector<int>& repeatTileColorIds){
    ...
    if(m_labelsPtr){
        if(!m_isTopToBottom){
            ...
            m_labelsPtr->moveRightOutsideCoordinateLabels(sf::Vector2f{0.f, m_tileLayerPtr->getTileSize().y});
        }
...
void GraphicBoard::moveTiles(const sf::Vector2f& offset){
    ...
    if(m_labelsPtr){
        ...
        m_labelsPtr->moveRightOutsideCoordinateLabels(offset);

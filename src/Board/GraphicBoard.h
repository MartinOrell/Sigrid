...
class GraphicBoard: public sf::Drawable{
  ...
  private:
    ...
    void initTileLayer(const LogicBoard& logicBoard, const BoardDesignContainer& config);
    void initPieceLayer(const LogicBoard& logicBoard, const BoardDesignContainer& config);

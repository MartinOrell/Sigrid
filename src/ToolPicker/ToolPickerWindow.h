...
namespace sigrid{
    class ToolPickerWindow: public sf::Drawable{
        public:
            ...
            ToolPickerWindow(const ToolPickerContainer& data, const std::vector<uint32_t>& squareColors, PieceManager* const pieceManagerPtr, ToolManager* const toolManagerPtr);

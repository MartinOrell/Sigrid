...
template class sigrid_list::Map<sigrid::CoordPair, sigrid::LogicArrow>;
template class sigrid_list::Map<sigrid::Coord, sigrid::GraphicTile>;
template class sigrid_list::Map<sigrid::Coord, sigrid::GraphicPiece>;
template class sigrid_list::Map<sigrid::Coord, sigrid::GraphicCircle>;
template class sigrid_list::Map<sigrid::Coord, sigrid::GraphicArrow>;
template class sigrid_list::Map<sigrid::CoordPair, sigrid::GraphicArrow>;
template class sigrid_list::Map<sigrid::Coord, sigrid::Icon>;
template class sigrid_list::Map<sigrid::Coord, sigrid::LogicTile>;
template class sigrid_list::Map<sigrid::Coord, sigrid::LogicPiece>;
template class sigrid_list::Map<sigrid::Coord, sigrid::LogicCircle>;
template class sigrid_list::Map<sigrid::Coord, sigrid::LogicArrow>;

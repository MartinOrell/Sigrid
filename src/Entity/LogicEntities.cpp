...
void LogicEntities::moveEntitiesRight(){
    moveEntitiesRight_h<list::SigridMap<Coord, LogicPiece>>(m_pieces);
    moveEntitiesRight_h<list::SigridMap<Coord, LogicCircle>>(m_circles);
    moveEntitiesRight_h<list::SigridMap<Coord, LogicArrow>>(m_arrows);
    moveEntitiesRight_h<list::SigridMap<Coord, LogicIcon>>(m_icons);
}
...
void LogicEntities::moveEntitiesLeft(){
    moveEntitiesLeft_h<list::SigridMap<Coord, LogicPiece>>(m_pieces);
    moveEntitiesLeft_h<list::SigridMap<Coord, LogicCircle>>(m_circles);
    moveEntitiesLeft_h<list::SigridMap<Coord, LogicArrow>>(m_arrows);
    moveEntitiesLeft_h<list::SigridMap<Coord, LogicIcon>>(m_icons);
}
...
void LogicEntities::moveEntitiesUp(){
    moveEntitiesUp_h<list::SigridMap<Coord, LogicPiece>>(m_pieces);
    moveEntitiesUp_h<list::SigridMap<Coord, LogicCircle>>(m_circles);
    moveEntitiesUp_h<list::SigridMap<Coord, LogicArrow>>(m_arrows);
    moveEntitiesUp_h<list::SigridMap<Coord, LogicIcon>>(m_icons);
}
...
void LogicEntities::moveEntitiesDown(){
    moveEntitiesDown_h<list::SigridMap<Coord, LogicPiece>>(m_pieces);
    moveEntitiesDown_h<list::SigridMap<Coord, LogicCircle>>(m_circles);
    moveEntitiesDown_h<list::SigridMap<Coord, LogicArrow>>(m_arrows);
    moveEntitiesDown_h<list::SigridMap<Coord, LogicIcon>>(m_icons);
}
